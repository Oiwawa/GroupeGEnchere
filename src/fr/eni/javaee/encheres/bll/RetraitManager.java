...
public class RetraitManager {
	...
	/**
	 * Methode pour créer un nouveau retrait. Verifie l'adresse, si adresse correct
	 * envoie, sinon erreur
	 * 
	 * @param retrait
	 * @return retrait
	...
	private static void validerAdresse(Retrait retrait, BusinessException businessException) {
		String testCP = "^(([0-9]{2})[0-9]{3})$";
		// Si la rue, le code postal et la ville ne sont pas indiqués, renvoie erreur
		if (retrait.getRue() == null || retrait.getRue().trim().equals("") || retrait.getCodePostal() == null
				|| retrait.getCodePostal().trim().equals("") || retrait.getVille() == null
